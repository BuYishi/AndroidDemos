...
import com.bu_ish.staggered_grid_demo.databinding.ActivityDemo1Binding;
import com.bu_ish.staggered_grid_demo.model.Image;
import com.bu_ish.staggered_grid_demo.ui.adapter.ImageRecyclerViewAdapter;
...
public class Demo1Activity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ActivityDemo1Binding binding = ActivityDemo1Binding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());
        binding.rvImage.setAdapter(new ImageRecyclerViewAdapter(this, getImageList()));
    }
